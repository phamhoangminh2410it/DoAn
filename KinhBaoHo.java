...
public class KinhBaoHo extends KinhMat
{
	...
	public KinhBaoHo(ArrayList <NhaCungCap> ncc, String tenTH, String tenSP, String maSP, String desCription, int soLuong, double giaBan, String nguonGoc)
	{
	...
	public void hienThongTinKinhBaoHo()
	{
		super.hienThongTin();
	}
}