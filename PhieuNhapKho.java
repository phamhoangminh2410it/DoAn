...
public class PhieuNhapKho extends Phieu
{
	...
	public PhieuNhapKho(int ngayNhap, String maPhieu, int soPhieu, String tenKH, String tenSP, int soLuong, String diaChi, int soDT, String eMail, int soTK, int trangThai)
	{
